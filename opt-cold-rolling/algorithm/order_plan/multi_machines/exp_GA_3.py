    ...
    def run(self) -> ProductionPlan:
        ...
        for generation in range(self.generations):
            ...
            for chromosome in population:
                plan = self.scheduler.generate_production_plan_positive(chromosome)
...
def generate_random_orders(num_orders: int = 5) -> List[OrderMultiFeature]:
    ...
    for i in range(num_orders):
        random.seed(i)
        date_range = random.randint(10, 30)
...
orders_obj_list = generate_random_orders(60)
